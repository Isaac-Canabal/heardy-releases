...
class MediaKitPlayer extends AudioPlayerPlatform {
  ...
  /// Patch de Heardy: acceso público al [Player] de `media_kit` para poder
  /// aplicarle filtros de audio (`af`, ecualizador/normalización) vía
  /// `NativePlayer.setProperty`, que la API pública de este paquete no
  /// expone. Ver `JustAudioMediaKit.rawPlayerFor` y
  /// `lib/services/audio_player_handler.dart` en el repo de Heardy.
